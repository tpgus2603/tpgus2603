...
야나와 플랫폼 
--
**맡은 역할**: 백엔드 개발 : DB설계 및 비즈니스 로직작성 ,인프라 구축
...
스마트 냉장고 시스템( 임베디드. Iot프로젝트) 
--
**맡은 역할**: 센서 및 액츄에이터 작동 코드 , 라즈베리 파이 간 서버-클라이언트 tcp통신 구현)
...
세줄스 앱(뉴스 세줄 요약 앱)
--
**맡은 역할** 백엔드 API 서버 및 머신러닝, 인프라 구축
GPT API를 기반으로 크롤링한 뉴스 데이터를 요역하여 제공하는 앱입니다.뉴스를 세줄로 요약하고 키워드를 제공합니다. GPT API를 사용하면 비용이 청구되고 수익의 불확실성으로 인해 앱스토어 출시는 보류중입니다
